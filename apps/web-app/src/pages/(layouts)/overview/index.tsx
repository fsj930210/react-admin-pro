  ...
  return (
    ...
    >
      <div className="text-2xl mb-2">
        {menu.icon ? (
          <Icon icon={menu.icon} size={iconSize} wrapperClassName="text-2xl" />
        ) : (
...
function OverviewPage() {
  ...
  return (
    <div className="p-6">
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_180px]">
        ...
        {anchorItems.length > 0 ? (
          <aside className="hidden xl:block">
            <Anchor activeMode="visible" className="sticky top-[100px]" items={anchorItems} />
          </aside>
        ) : null}
      </div>
    </div>
