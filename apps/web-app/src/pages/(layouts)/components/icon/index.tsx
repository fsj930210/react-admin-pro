	...
	return (
		<div className="container mx-auto p-6">
			...
			<section className="mb-8">
				...
				<p className="mb-4">
					基础图标组件，用于显示单个图标，支持 Iconify 图标，本地Iconify图标，自定义图标，图片图标。
				</p>
			...
			<section className="mb-8">
				...
				<p className="mb-4">
					IconView 组件默认内置了三个图标集：lucide、carbon 和 ri，无需额外导入即可使用：
				</p>
				<pre className="bg-muted p-4 rounded-md text-sm mb-4">{`<IconView />`}</pre>
				<h3 className="text-lg font-medium mb-2">添加自定义图标集</h3>
				<p className="mb-4">
					要在默认图标集的基础上添加新的图标集，需要先安装对应的 iconify-json 包，然后在 IconView
					组件中使用 iconSets 属性：
				</p>
...
/>`}
				...
				<p className="mb-4">
					如果只想使用自定义图标集，不包含默认图标集，可以设置 disableDefaultIconSets 属性：
				</p>
