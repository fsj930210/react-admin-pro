...
import { useReSize, type Direction } from "@rap/hooks/use-resize";
...
function ResizeFeaturePage() {
  ...
  // 允许的缩放方向（8个方向）
  const resizableDirections: Direction[] = [
    'n', 's', 'w', 'e', 'nw', 'ne', 'sw', 'se'
  ];
  
  // 使用 resize hook
  const { ref, handleResize, isResizing } = useReSize(
    size,
    setSize,
    position,
    setPosition,
    ...
    <div className="p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg" style={{ height: '500px' }}>
          ...
          <div
            ref={ref}
            className={`absolute bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg shadow-lg transition-shadow ${
          ...
          >
            ...
            <div className="flex items-center justify-center h-full text-white">
              <div className="text-center">
                <div className="text-lg font-semibold mb-1">可调整大小</div>
        ...
        <div className="mt-8 bg-gray-100 rounded-lg p-6">
          ...
          <ul className="space-y-2 text-sm text-gray-700">
            ...
            <li className="flex items-start">
              <span className="mr-2">•</span>
              <span>支持8个方向：上(n)、下(s)、左(w)、右(e)、左上(nw)、右上(ne)、左下(sw)、右下(se)</span>
            </li>
          </ul>
        </div>
      </div>
