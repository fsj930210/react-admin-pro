...
const { selector: useAppConfigSelector } = createStore<AppConfigStore>(
  (set) => ({
    ...
    count: 0,
    setLayoutConfig: createSetter<AppConfigState, "layoutConfig">(
      set,
      "layoutConfig"
    ),
    setAppearanceConfig: createSetter<AppConfigState, "appearanceConfig">(
      set,
      "appearanceConfig"
    ),
    setCommonConfig: createSetter<AppConfigState, "commonConfig">(
      set,
      "commonConfig"
    ),
