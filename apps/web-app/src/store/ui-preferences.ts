...
const readStoredTheme = (preferences: UIPreferences): AppTheme | undefined => {
  if (typeof window === "undefined") return undefined;
...
const storedTheme = readStoredTheme(initialPreferences);
if (storedTheme) {
  initialPreferences.appearance.theme = storedTheme;
}
