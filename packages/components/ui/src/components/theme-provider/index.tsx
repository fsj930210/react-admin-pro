...
const getFallbackTheme = (themes: string[], defaultTheme: string) => {
  return themes.includes(defaultTheme) || defaultTheme === "system" ? defaultTheme : themes[0];
};
...
const ActiveThemeProvider: React.FC<ActiveThemeProviderProps> = ({
  ...
  }, [attribute, enableColorScheme, resolvedColorSchemeMap, resolvedTheme, scope, themes]);
  ...
  const contextValue = useMemo<ThemeContextValue>(
    ...
    [availableThemes, enableSystem, forcedTheme, resolvedTheme, setTheme, systemTheme, theme]
  );
