  ...
  return (
    <li key={tab.value} className="h-full pt-1">
      <div className={cn("group relative flex-center h-full w-40 hover:not-[.active]:after:border-b-layout-tabs-accent", {
        "after:absolute after:top-0 after:left-0 after:w-full after:h-0 after:z-1 after:border-l after:border-l-[16px] after:border-l-transparent after:transition-all after:duration-200 after:ease-in-out": true,
        "after:border-r after:border-r-[16px] after:border-r-transparent after:border-b after:border-b-[35px] after:border-b-layout-tabs-border": true,
