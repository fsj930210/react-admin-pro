// 文档地址 https://www.diceui.com/docs/components/radix/media-player
"use client";
...
function MediaPlayerLoading(props: MediaPlayerLoadingProps) {
	...
	return (
		...
		>
			{children ?? (
				<Loader2 className="size-20 animate-spin stroke-[.0938rem] text-primary" />
			)}
		</LoadingPrimitive>
	);
}
...
function MediaPlayerCaptions(props: React.ComponentProps<typeof Button>) {
	...
	return (
		<MediaPlayerTooltip tooltip="Captions" shortcut="C">
			...
			>
				{children ??
					(isSubtitlesActive ? <Subtitles /> : <CaptionsOff />)}
			</Button>
		</MediaPlayerTooltip>
	);
}
