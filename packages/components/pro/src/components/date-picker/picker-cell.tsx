  ...
  return (
    <Button
      ...
      className={cn(
        ...
        info.rangeMiddle &&
          "rounded-none border-transparent bg-accent/70 text-foreground hover:bg-accent/70",
        isStrongSelected &&
          "rounded-md border-primary bg-primary text-primary-foreground hover:bg-primary/90 hover:text-primary-foreground",
