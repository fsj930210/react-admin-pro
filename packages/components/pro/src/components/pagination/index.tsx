		...
		<UIPagination className={className}>
			...
			<PaginationContent className={cn("flex-wrap gap-2", contentClassName)}>
				...
				{pages.map((pageItem, index) => (
					<PaginationItem key={index}>
						{pageItem === "ellipsis" ? (
							...
							itemRender ? (
								itemRender(pageItem as number, 'page', (
									<PaginationLink
				...
				{showSizeChangerFinal && (
					<Select value={String(pageSizeValue)} onValueChange={handlePageSizeChange} disabled={disabled}>
